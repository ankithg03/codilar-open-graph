...
{
    const XML_PATH_FOR_SEO_OPEN_GRAPH_MODULE_ENABLE
        = 'seo_open_graph_section/general/core_module_enable';
    ...
    public function isOpenGraphModuleEnabled()
    {
        ...
        return (
            (bool)$this->scopeConfig->getValue(
                self::XML_PATH_FOR_SEO_OPEN_GRAPH_MODULE_ENABLE, $storeScope
            )
        );
    }
